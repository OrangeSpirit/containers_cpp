...
TEST(queue, case1) {
  ...
  s21::queue<double> s21_queue_double{1.1, 1.2, 1.3};
  s21::queue<std::string> s21_queue_string{"aaa", "bbb", "ccc"};

  EXPECT_EQ(s21_queue_int.size(), 3);

  EXPECT_EQ(s21_queue_double.size(), 3);

  EXPECT_EQ(s21_queue_string.size(), 3);
}
